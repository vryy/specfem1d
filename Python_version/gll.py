...
# The values can be obtained from Julia (package FastGaussQuadrature)
# z, w = gausslobattor(n)

GLL_POINTS = {
    1: np.array([-1.0, 1.0]),
    2: np.array([-1.0, 0.0, 1.0]),
    3: np.array([-1.0, -0.4472135954999579, 0.4472135954999579, 1.0]),
...
GLL_WEIGHTS = {
    1: np.array([1.0, 1.0]),
    2: np.array([0.3333333333333333, 1.3333333333333333, 0.3333333333333333]),
    3: np.array([0.16666666666666666, 0.8333333333333333, 0.8333333333333333, 0.16666666666666666]),
...
# This value is generated according to alpha = 0, beta = 1
# The values can be obtained from Julia (package Jacobi)
# z = zglj(n, 0, 1)
# w = wglj(z, 0, 1)

GLJ_POINTS = {
    1: np.array([-1.0, 1.0]),
    2: np.array([-1.0, 0.2, 1.0]),
    3: np.array([-1.0, -0.2612038749637414, 0.5469181606780271, 1.0]),
...
GLJ_WEIGHTS = {
    1: np.array([0.666666666666666, 1.333333333333333]),
    2: np.array([0.111111111111111, 1.388888888888888, 0.5]),
    3: np.array([0.0333333333333333, 0.6142977396044843, 1.0857022603955162, 0.266666666666666]),
